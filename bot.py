...
MAX_LONGS       = int(os.environ.get("MAX_LONGS",  "30"))   # máx posiciones LONG
MAX_SHORTS      = int(os.environ.get("MAX_SHORTS", "30"))   # máx posiciones SHORT
TP_PCT          = float(os.environ.get("TP_PCT", "0.90"))    # Take Profit: +1% ROI
